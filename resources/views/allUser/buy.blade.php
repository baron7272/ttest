          ...
          <div class="uk-grid-large" uk-grid>
            <div class="uk-width-2-3@m fead-area">
              <!-- <div class="section-small pt-0">
                        ...
                        <div class="uk-card uk-card-default uk-card-self uk-card-body uk-width-1-2@m" id="card-buy">
                          <h3 style="color:#ff334b;"> Credit Wallet</h3>
                        <div class="uk-form-group">
                        <div class="uk-position-relative">
                            <input class="uk-input bg-secondary" type="text" placeholder="Amount">
                        </div>
                        </div>
                        <button type="submit" class="button danger large block mb-4 button-transact" > Credit</button>
