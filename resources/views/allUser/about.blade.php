            ...
            <div class="sections">
              <div class="profile-card-side">
                <a href="profile.html"
                  ><img
                    class="image-avatar"
                    src="{{asset('avatars/avatar-6.jpg')}}"
                    width="300px"
                    alt=""
                /></a>
            ...
            <div class="main_content_inner">
                ...
                <div class="uk-grid-large" uk-grid>
                    ...
                    <div class="uk-width-2-3@m fead-area">
                        ...
                        <div >
                            <div>
                                <img src="assets/user/images/avatars/avatar-6.jpg" width="80px" alt="">
                                <div class="Executive-profile">
                                    <h3 class="avatar-name"> Eloka Nwobi</h3>
                        ...
                        <h1>
                            <img src="assets/user/images/icons/image-v.svg" width="30" alt="">
                            About </h1>
                            <p>bkdvhflbvhrjfdabvhjedbvhebdvjebvjibuivjebivjuijbvreijbgubnugrij fijbveufjibv</p>
                   </div>
                    ...
                    <div class="uk-width-expand">
                        ...
                        <a href="#" class="uk-link-reset">
                            <div class="uk-flex uk-flex-top py-2 pb-0 pl-2 mb-4 bg-secondary-hover rounded winner-card">
                                <img src="assets/user/images/icons/gift-icon.png" width="35px" class="mr-3" alt="">
                                <p> <strong> Jessica Erica </strong> <br> singer</p>
                            </div>
                        </a>


                        <div class="p-5 mb-3 rounded uk-background-cover uk-light"
                            style="background-blend-mode: color-burn; background-color:rgba(0, 126, 255, 0.06); height:300px;"
                            data-src="assets/user/images/events/img-5.jpg " uk-img>
                            ...
                            <div class="post-description">
                                <div class="uk-grid-small" uk-grid>
                                    ...
                                    <div class="uk-width-1-2@m uk-width-1-2">
                                        <img src="assets/user/images/post/img-2.jpg" class="rounded" alt="">
                                    </div>
                                    <div class="uk-width-1-2@m uk-width-1-2 uk-position-relative">
                                        <img src="assets/user/images/post/img-3.jpg" class="rounded" alt="">
