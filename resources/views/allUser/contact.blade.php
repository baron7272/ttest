...
<div class="profile-card-side">
              <div class="avatar-background">
                 ...
                 <img class="photo-user" src="{{asset('images/post/sponsor.jpeg')}}">
                 </div>

                 <div class="avatar-info">
                   <p class="username">Oraclescholezy</p>
                   <p class="user-role">magician</p>
                   </div>
                   <hr class="hr-avatar">
                  <div class="fans-record">
                    <div class="fans-info">
                      Fans
                    </div>
                    ...
                    <!-- <p class="fan-record">Follows <span class="follows-span">567</span></p>
                    <p class="fan-record">Balance <span class="follows-span">$3000</span></p> -->
                </div>
                <div class="fans-record">
                    <div class="fans-info">
                      Follows
  ...
  <path d="M0 1.5A1.5 1.5 0 0 1 1.5 0h2A1.5 1.5 0 0 1 5 1.5v2A1.5 1.5 0 0 1 3.5 5h-2A1.5 1.5 0 0 1 0 3.5v-2zM0 8a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V8zm1 3v2a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2H1zm14-1V8a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v2h14zM2 8.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0 4a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5z"/>
                ...
                <li>
                  <a href="">
                    <img src="{{asset('images/icons/policy.png')}}" alt="" />
                    <span> Policy </span>
                  </a>
                </li>
        ...
        <div class="main_content_inner">
          <div class="uk-grid-large uk-grid" uk-grid="">
            <div class="uk-width-2-3@m fead-area uk-first-column">
                        ...
                        <div class="uk-card uk-card-default uk-card-self uk-card-body week-schedule uk-scrollspy-inview" uk-scrollspy="cls: uk-animation-slide-left; repeat: true" style="">
                        <div class="container inform-us">
...
<fieldset>
<input placeholder="Topic" type="text" tabindex="1" required="" autofocus="">
</fieldset>
...
Submit
            ...
            <div class="uk-width-expand">
              ...
              <div class="uk-flex uk-flex-top py-2 pb-0 pl-2 mb-4  rounded winner-card" id="Day-star">
                <a href="#">
                <img src="http://localhost:8000/images/icons/gift-icon.png" width="40px" class="mr-3" alt="">
                </a>
                  <p>
              ...
              <div class="p-5 mb-3 rounded uk-background-cover uk-light" style="background-blend-mode: color-burn; background-color: rgba(0, 0, 255, 0.03); height: 300px; background-image: url(&quot;http://localhost:8000/images/events/img-5.jpg&quot;);" data-src="http://localhost:8000/images/events/img-5.jpg " uk-img="">
              ...
              <div uk-sticky="offset:70 ; media : @m" class="uk-sticky">
                <h3 class="mt-5 mb-5">Sponsors</h3>
                <div class="post-description">
                  <div class="uk-grid-small uk-grid" uk-grid="">
                    <div class="uk-width-1-2@m uk-width-1-2 uk-first-column">
                      <img src="http://localhost:8000/images/post/img-2.jpg" class="rounded" alt="">
                    </div>
                    <div class="uk-width-1-2@m uk-width-1-2 uk-position-relative">
                      <img src="http://localhost:8000/images/post/img-3.jpg" class="rounded" alt="">
                    </div>
                    <div class="uk-width-1-2@m uk-width-1-2 uk-grid-margin uk-first-column">
                      <img src="http://localhost:8000/images/post/img-2.jpg" class="rounded" alt="">
                    </div>
                    <div class="uk-width-1-2@m uk-width-1-2 uk-grid-margin">
                      <img src="http://localhost:8000/images/post/img-2.jpg" class="rounded" alt="">
                    </div>
                    <div class="uk-width-1-2@m uk-width-1-2 uk-grid-margin uk-first-column">
                      <img src="http://localhost:8000/images/post/img-2.jpg" class="rounded" alt="">
              ...
              </div><div class="uk-sticky-placeholder" hidden="" style="height: 410px; margin: 0px;"></div>
            </div>
          </div>
        </div>
...
Submit
            ...
            <div class="uk-width-expand">
              ...
              <div
                ...
                <a href="#">
                <img
                    src="{{asset('images/icons/gift-icon.png')}}"
                    width="40px"
                    class="mr-3"
                    alt=""
                  />
              ...
              <div
                ...
                style="
                  ...
                  height: 300px;
                "
                data-src="{{asset('images/events/img-5.jpg')}} "
                uk-img
              >
                <div class="uk-width-4-5">
                  <!-- <h3 class="mb-2">
                ...
                <div class="post-description">
                  <div class="uk-grid-small" uk-grid>
                    <div class="uk-width-1-2@m uk-width-1-2">
                      <img
                        src="{{asset('images/post/img-2.jpg')}}"
                        class="rounded"
                        alt=""
                      />
                    </div>
                    ...
                    >
                      <img
                        src="{{asset('images/post/img-3.jpg')}}"
                        class="rounded"
                        alt=""
                      />
                    </div>
                ...
                <div class="uk-position-relative uk-visible-toggle" uk-slider>
                  ...
                  <ul class="uk-slider-items uk-child-width-1-1 story-slider">
                    ...
                    <li>
                      ...
                      >
                        <img
                          src="{{asset('images/avatars/avatar-lg-1.jpg')}}"
                          alt=""
                        />
                      </div>
                    </li>
                ...
                <div class="uk-position-relative uk-visible-toggle" uk-slider>
                  ...
                  <ul class="uk-slider-items uk-child-width-1-1 story-slider">
                    ...
                    <li>
                      <div class="story-slider-image">
                        <img
                        src="{{asset('images/avatars/avatar-lg-3.jpg')}}"
                          alt=""
                        />
                      </div>
                    </li>
                ...
                <div class="uk-position-relative uk-visible-toggle" uk-slider>
                  ...
                  <ul class="uk-slider-items uk-child-width-1-1 story-slider">
                    <li>
                      ...
                      >
                        <img
                        src="{{asset('images/avatars/avatar-lg-2.jpg')}}"
                          alt=""
                        />
                      </div>
                    </li>
