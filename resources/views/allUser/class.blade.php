...
<body>
            ...
            <div class="sidebar">
                <div class="sidebar_innr" data-simplebar>
                    <div class="sections">
                        ...
                        <div class="butt">
                            <button class="shifty Buy-btn"><span>Buy </span></button>
                            <button class=" shifty"><span>Share</span></button>
                        </div>
                        <ul>
                            <li>
                    ...
                    <!-- <div class="sections">
                        ...
                        <ul>
                            ...
                            <li> <a href="timeline.html"> <img src="assets/user/images/avatars/avatar-2.jpg" alt="">
                                    <span> Alex Dolgove </span> <span class="dot-notiv"></span></a></li>
                            <li> <a href="timeline.html"> <img src="assets/user/images/avatars/avatar-7.jpg" alt="">
                            ...
                            <li> <a href="group-feed.html"> <img src="assets/user/images/group/group-4.jpg" alt="">
                ...
                <div class="header-innr">
                    ...
                    <div class="head_user">
                        ...
                        <a class="opts_account" href="#" aria-expanded="false"> <img
                                src="http://localhost:8000/images/avatars/avatar-2.jpg" alt=""></a>
                ...
                <div class="uk-grid-large" uk-grid>
                    ...
                    <div class="uk-width-2-3@m uk-first-column">
                        <div class="uk-child-width-1-2@m uk-grid-match" uk-grid>
                            <div>
                                <div class="uk-card uk-card-default uk-card-self uk-card-body week-schedule"
                                    uk-scrollspy="cls: uk-animation-slide-left; repeat: true">

                                    <div class="uk-first-column ">
                                        @foreach ($value as $unit)
                                            <div>
                                                <h6 class="tag-h6">{{ $unit->week }}</h6>
                                                ...
                                                <div>
                                                    ...
                                                    @else
                                                        @foreach ($unit->value as $u)
                                                            ...
                                                            <input type="hidden" value="{{ $u->category }}"
                                                                id="uploadId" />
                                                            ...
                                                            <button type="submit" class="dot mt-4"
                                                                onClick="getAll('{{ $u->category }}', '{{ csrf_token() }}');">{{ $u->category }}</button>
                            ...
                            <div>
                                <div class="uk-card uk-card-default uk-card-self uk-card-body"
                                    uk-scrollspy="cls: uk-animation-slide-right; repeat: true">
                                    <h6 class="tag-h6">Music <span style="padding-left: 200px;">0</span></h6>
                                    <hr>

                                    <div class="list-items" id="list-all">
                                        ...
                                        <div class="list-item-media">
                                            <img src="{{ asset('images/group/group-2.jpg') }}" alt="">
                                        </div>
                                        <div class="list-item-content">
                                            ...
                                            <div class="row">
                                                <div class="column">
                                                    <img src="{{ asset('images\events\flag.png') }}" alt="" />
                                                </div>
                        ...
                        <div class="uk-card-default Select-categories">
                            @foreach ($categories as $category)
                                <div class="row category-rows">
                                    <div class="col"><a href="#"><span class="category"></span></a>
                                        <h6 class="category-activity">{{ $category->newCategory }}</h6>
                                    </div>
                    ...
                    <div class="uk-width-expand">
                        ...
                        <div class="uk-flex uk-flex-top py-2 pb-0 pl-2 mb-4  rounded winner-card" id="Day-star">
                            <a href="#">
                                <img src="{{ asset('images/icons/gift-icon.png') }}" width="40px" class="mr-3" alt="" />
                            </a>
                  ...
                  height: 300px;
                " data-src="{{ asset('images/events/img-5.jpg') }} " uk-img>
                        ...
                        <div uk-sticky="offset:70 ; media : @m">
                            ...
                            <div class="post-description">
                                <div class="uk-grid-small" uk-grid>
                                    ...
                                    <img src="{{ asset('/images/post/img-2.jpg') }}" class="rounded" alt="" />
                                    <div class="uk-width-1-2@m uk-width-1-2 uk-position-relative">
                                        <img src="{{ asset('/images/post/img-3.jpg') }}" class="rounded" alt="" />
                        ...
                        <li>
                            <a href="#">
                                <div class="story-user-media">
                                    <img src="assets/user/user/images/avatars/avatar-1.jpg" alt="">
                                </div>
                    ...
                    <ul class="story-side-list"
                        ...
                        <li>
                            <a href="#">
                                ...
                                <div class="story-user-innr">
                                    <h5> Dennis Han </h5>
                                    <p> <span class="story-count"> 2 new </span> <span class="story-time-ago"> 4hr
                                            ago
                                        </span></p>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#">
                                ...
                                <div class="story-user-innr">
                                    <h5> Stella Johnson </h5>
                                    <p> <span class="story-count"> 3 new </span> <span class="story-time-ago"> 1hr
                                            ago
                                        </span></p>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#">
                                ...
                                <div class="story-user-innr">
                                    <h5> Erica Jones </h5>
                                    <p> <span class="story-count"> 2 new </span> <span class="story-time-ago"> 3hr
                                            ago
                                        </span></p>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#">
                                ...
                                <div class="story-user-innr">
                                    <h5> Adrian Mohani </h5>
                                    <p> <span class="story-count"> 1 new </span> <span class="story-time-ago"> 4hr
                                            ago
                                        </span></p>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#">
                                ...
                                <div class="story-user-innr">
                                    <h5> Alex Dolgove </h5>
                                    <p> <span class="story-count"> 3 new </span> <span class="story-time-ago"> 7hr
                                            ago
                                        </span></p>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#">
                                ...
                                <div class="story-user-innr">
                                    <h5> Stella Johnson </h5>
                                    <p> <span class="story-count"> 2 new </span> <span class="story-time-ago"> 8hr
                                            ago
                                        </span></p>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#">
                                ...
                                <div class="story-user-innr">
                                    <h5> Erica Jones </h5>
                                    <p> <span class="story-count"> 3 new </span> <span class="story-time-ago"> 10hr
                                            ago
                                        </span></p>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#">
                                ...
                                <div class="story-user-innr">
                                    <h5> Alex Dolgove </h5>
                                    <p> <span class="story-count"> 3 new </span> <span class="story-time-ago"> 14hr
                                            ago
                                        </span></p>
                                </div>
                            </a>
                            ...
                            <div class="uk-position-relative uk-visible-toggle" uk-slider>
                                ...
                                <ul class="uk-slider-items uk-child-width-1-1 story-slider">
                                    ...
                                    <li>
                                        <div
                                            class="story-slider-image uk-animation-kenburns uk-animation-reverse uk-transform-origin-center-left">
                                            <img src="assets/user/images/avatars/avatar-lg-1.jpg" alt="">
                                        </div>
                                    </li>
                                </ul>
                        ...
                        <li>
                            ...
                            <div class="uk-position-relative uk-visible-toggle" uk-slider>
                                ...
                                <ul class="uk-slider-items uk-child-width-1-1 story-slider">
                                    ...
                                    <li>
                                        <div class="story-slider-image">
                                            <img src="assets/user/images/avatars/avatar-lg-3.jpg" alt="">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="story-slider-image">
                                            <img src="assets/user/images/avatars/avatar-lg-2.jpg" alt="">
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="uk-position-relative uk-visible-toggle" uk-slider>
                                ...
                                <ul class="uk-slider-items uk-child-width-1-1 story-slider">
                                    <li>
                                        <div
                                            class="story-slider-image uk-animation-kenburns uk-animation-reverse uk-transform-origin-center-left">
                                            <img src="assets/user/images/avatars/avatar-lg-4.jpg" alt="">
                                        </div>
                            ...
                            <div class="uk-position-relative uk-visible-toggle" uk-slider>
                                ...
                                <ul class="uk-slider-items uk-child-width-1-1 story-slider">
                                    <li>
                                        <div
                                            class="story-slider-image uk-animation-kenburns uk-animation-reverse uk-transform-origin-center-left">
                                            <img src="assets/user/user/images/avatars/avatar-lg-4.jpg" alt="">
                                        </div>
            ...
            <div class="uk-offcanvas-bar">
                ...
                <div class="sidebar-chat-head mb-2">
                    ...
                    <div class="btn-actions">
                        ...
                        <a href="#" uk-tooltip="title: settings ;offset:7"> <i class="icon-feather-settings"></i>
                        </a>
                ...
                <a href="#">
                    <div class="contact-list">
                        <div class="contact-list-media"> <img src="assets/user/images/avatars/avatar-1.jpg" alt="">
                            <span class="online-dot"></span>
                        </div>
                        <h5> Erica Jones </h5>
                    </div>
                ...
                <a href="#">
                    <div class="contact-list">
                        <div class="contact-list-media"> <img src="assets/user/images/avatars/avatar-7.jpg" alt="">
                ...
                <a href="#">
                    <div class="contact-list">
                        <div class="contact-list-media"> <img src="assets/user/images/avatars/avatar-5.jpg" alt="">
                            <span class="offline-dot"></span>
                        </div>
                        <h5> Alex Dolgove </h5>
                    </div>
                ...
                <a href="#">
                    <div class="contact-list">
                        <div class="contact-list-media"> <img src="assets/user/images/avatars/avatar-2.jpg" alt="">
                            <span class="online-dot"></span>
                        </div>
                        <h5> Dennis Han</h5>
                    </div>
                ...
                <a href="#">
                    <div class="contact-list">
                        <div class="contact-list-media"> <img src="assets/user/images/avatars/avatar-4.jpg" alt="">
                            <span class="online-dot"></span>
                        </div>
                        <h5> Erica Jones </h5>
                    </div>
                ...
                <a href="#">
                    <div class="contact-list">
                        <div class="contact-list-media"> <img src="assets/user/images/avatars/avatar-3.jpg" alt="">
                            <span class="offline-dot"></span>
                        </div>
                        <h5> Stella Johnson </h5>
                    </div>
    ...
    <!-- For Night mode -->
    <script>
        function getAll($category, $token) {
            console.log($token);
            ...
            $.ajax({
                        ...
                        success: function(data) {
                            ...
                            for (i in data) {
                                $('#list-all').append(" <
                                    div class = "list-item-media" >
                                    <
                                    img src = "{{ asset('images/group/group-2.jpg') }}"
                                    alt = "" >
                                    <
                                    /div> <
                                    div class = "list-item-content" >
                                    ...
                                    div class = "column" >
                                    <
                                    img src = "{{ asset('images\events\flag.png') }}"
                                    alt = "" / >
                                    <
                                    /div>
                        ...
                        $(document).ready(function() {
                            ...
                            $('.cls_btn').click(function(e) {
                                ...
                                $.ajax({
                                    type: "post",
                                    data: "content=" + cat_name + "&_token=" + token +
                                        "&uploadId=" + uploadId,
                            ...
                            var auto_refresh = setInterval(
                                function() {
                                    $('#category').load('<?php echo url('
                                        admin / cats '); ?>').fadeIn("slow");
                                }, 100);
                        });
