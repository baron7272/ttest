...
//&& $user->contestId != $uploadDetails->uploadedBy
    ...
    public function homeSelectedCategory()
    {
        ...
        try {
            ...
            $contestant5 = DB::table('contestants')->where('newCategory','!=',NULL)->where('newCategory', $selectedCategory)->whereNull('deleted_at')->pluck('id');
    ...
    public function homePage()
    {
        ...
        if($user->username->username !='baron'){
        try {
...
//            $counttt = DB::table('uploads')->whereNull('deleted_at')->orderBy('id', 'desc')->count();
    ...
    public function voting(Request $request)
    {
        ...
        try {
            ...
            $number = $myTransaction->newBalance / 10;
            ...
            if ($number >= $request->counting) {
                ...
                $uuau->model = 'Single';
                $uuau->title = 'Notice';
                $uuau->content = 'Naira' . $paid . ' ' . 'to your favorite contestant.';
                $uuau->type = 'Text';
                $uuau->save();
